...
import db.config.conection.DbConection;
import db.config.querys.DbQuerys;
...
public class DaoConsultas implements Operaciones {
   ...
   /* public static int eliminarElemento(DtoLibros DTOLibros){
    ...
    @Override
    public int eliminarLibro(DtoLibros DTOLibros) throws Exception {
        int fila = 0;
        Connection connection=null;
        try{
            connection = DbConection.abrirConexion();
